...
function love.update(dt)
	...
	if love.mouse.isDown ('l') then
		map[math.floor(love.mouse.getX() / RECT_SIZE)][math.floor(love.mouse.getY() / RECT_SIZE)] = true
		temp_map[math.floor(love.mouse.getX() / RECT_SIZE)][math.floor(love.mouse.getY() / RECT_SIZE)] = true
	elseif love.mouse.isDown ('r') then
		map[math.floor(love.mouse.getX() / RECT_SIZE)][math.floor(love.mouse.getY() / RECT_SIZE)] = false
		temp_map[math.floor(love.mouse.getX() / RECT_SIZE)][math.floor(love.mouse.getY() / RECT_SIZE)] = false
	end
